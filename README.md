...
```scala
libraryDependencies += "io.github.sungiant" %% "zenith" % "0.1.2"
```
...
```scala
libraryDependencies += "io.github.sungiant" %% "zenith-netty" % "0.1.2"
libraryDependencies += "io.github.sungiant" %% "zenith-plugins" % "0.1.2"
```
